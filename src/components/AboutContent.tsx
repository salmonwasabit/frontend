        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground mb-6">
              ก่อตั้งขึ้นด้วยความหลงใหลในนวัตกรรมและคุณภาพ podzoon
            ...
            <p className="text-muted-foreground mb-6">
              ...
              ของสิ่งที่เป็นไปได้ในอุตสาหกรรมการสูบไอ
              ทุกผลิตภัณฑ์ที่เรานำเสนอได้รับการคัดสรรและทดสอบอย่างพิถีพิถัน
            ...
            {[
              {
                ...
                description:
                  "เราไม่ประนีประนอมกับคุณภาพ ทุกผลิตภัณฑ์ผ่านการทดสอบอย่างเข้มงวด",
              },
              {
                title: "นวัตกรรม",
                description:
                  "ผลักดันขีดจำกัดอย่างต่อเนื่องด้วยเทคโนโลยีและการออกแบบล่าสุด",
              },
              {
                title: "มุ่งเน้นลูกค้า",
                description:
                  "ความพึงพอใจของคุณคือลำดับความสำคัญของเรา เราเป็นเพื่อนคู่ใจในการเดินทางสูบไอของคุณ",
              },
            ].map((value, index) => (
              <motion.div
                key={value.title}
