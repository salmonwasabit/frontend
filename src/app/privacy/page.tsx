        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 mb-6">
              VAPE LIFE เคารพความเป็นส่วนตัวของผู้ใช้ทุกคน และมุ่งมั่นที่จะปกป้องข้อมูลส่วนบุคคลของคุณ
            </p>
            
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">ข้อมูลที่เราเก็บรวบรวม</h2>
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">การใช้ข้อมูล</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">การแบ่งปันข้อมูล</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">ความปลอดภัย</h2>
            <p className="text-gray-600 mb-6">
